    ...
    client.send_message(message.chat.id,
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "📲 Supported Channel", url=f"https://t.me/{UPDATES_CHANNEL}"), 
                    InlineKeyboardButton(
                        "💬 Supported Group", url=f"https://t.me/{SUPPORT_GROUP}")
                ],[
                    InlineKeyboardButton(
                        "🔆 Owner 🔆", url=f"https://t.me/Sasmithakr")
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '📲 Supported Channel', url=f"https://t.me/{UPDATES_CHANNEL}"),
             InlineKeyboardButton(text = '💬 Supported Group', url=f"https://t.me/{SUPPORT_GROUP}")],
            [InlineKeyboardButton(text = '🔆 Owner 🔆', url=f"https://t.me/Sasmithakr")],
